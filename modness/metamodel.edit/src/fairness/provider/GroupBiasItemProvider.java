...
/**
 * This is the item provider adapter for a {@link fairness.GroupBias} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupBiasItemProvider extends BiasItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GroupBiasItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GroupBias"));
	}
	...
	public String getText(Object object) {
		String label = ((GroupBias)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GroupBias_type") :
			getString("_UI_GroupBias_type") + " " + label;
	}
