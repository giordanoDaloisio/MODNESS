...
binarize(data, 'respect', operator, operator_value, TrueTrue)
...
dataset_unprivileged_group = {'respect': 0}
dataset_privileged_group = {'respect' : 1}
...
GEI= (1 / (alpha * (1 - alpha))) * (
    metrics.probability("respect == 1 and tot_recommendations == 1")
    * metrics.probability("respect == 0", "tot_recommendations == 1"))
