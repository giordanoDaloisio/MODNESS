...
public class ModnessParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ModnessGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGroupAnalysisAccess().getGroup_11(), "rule__GroupAnalysis__Group_11__0");
			builder.put(grammarAccess.getGroupAnalysisAccess().getGroup_14(), "rule__GroupAnalysis__Group_14__0");
			builder.put(grammarAccess.getGroupAnalysisAccess().getGroup_18(), "rule__GroupAnalysis__Group_18__0");
			...
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetAssignment_6(), "rule__GroupAnalysis__DatasetAssignment_6");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetAssignment_7_1(), "rule__GroupAnalysis__DatasetAssignment_7_1");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetUnprivilegedGroupAssignment_10(), "rule__GroupAnalysis__DatasetUnprivilegedGroupAssignment_10");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetUnprivilegedGroupAssignment_11_1(), "rule__GroupAnalysis__DatasetUnprivilegedGroupAssignment_11_1");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetPrivilegedGroupAssignment_13(), "rule__GroupAnalysis__DatasetPrivilegedGroupAssignment_13");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetPrivilegedGroupAssignment_14_1(), "rule__GroupAnalysis__DatasetPrivilegedGroupAssignment_14_1");
			builder.put(grammarAccess.getGroupAnalysisAccess().getMetricAssignment_17(), "rule__GroupAnalysis__MetricAssignment_17");
			builder.put(grammarAccess.getGroupAnalysisAccess().getMetricAssignment_18_1(), "rule__GroupAnalysis__MetricAssignment_18_1");
