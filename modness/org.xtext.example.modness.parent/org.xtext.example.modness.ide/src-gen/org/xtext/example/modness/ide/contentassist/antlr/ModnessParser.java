...
public class ModnessParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ModnessGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGroupBiasAccess().getGroup_10(), "rule__GroupBias__Group_10__0");
			builder.put(grammarAccess.getGroupBiasAccess().getGroup_15(), "rule__GroupBias__Group_15__0");
			builder.put(grammarAccess.getGroupBiasAccess().getGroup_23(), "rule__GroupBias__Group_23__0");
			builder.put(grammarAccess.getGroupBiasAccess().getGroup_28(), "rule__GroupBias__Group_28__0");
			builder.put(grammarAccess.getGroupBiasAccess().getGroup_34(), "rule__GroupBias__Group_34__0");
			...
			builder.put(grammarAccess.getGroupAnalysisAccess().getGroup_6(), "rule__GroupAnalysis__Group_6__0");
			builder.put(grammarAccess.getGroupAnalysisAccess().getGroup_10(), "rule__GroupAnalysis__Group_10__0");
			builder.put(grammarAccess.getGroupAnalysisAccess().getGroup_13(), "rule__GroupAnalysis__Group_13__0");
			...
			builder.put(grammarAccess.getDatasetSensitiveGroupAccess().getGroup_10(), "rule__DatasetSensitiveGroup__Group_10__0");
			...
			builder.put(grammarAccess.getGroupSizeAccess().getGroup_3(), "rule__GroupSize__Group_3__0");
			...
			builder.put(grammarAccess.getDatasetPositiveOutcomeAccess().getGroup_9(), "rule__DatasetPositiveOutcome__Group_9__0");
			...
			builder.put(grammarAccess.getGroupBiasAccess().getDomainAssignment_6(), "rule__GroupBias__DomainAssignment_6");
			builder.put(grammarAccess.getGroupBiasAccess().getSourceAssignment_9(), "rule__GroupBias__SourceAssignment_9");
			builder.put(grammarAccess.getGroupBiasAccess().getSourceAssignment_10_1(), "rule__GroupBias__SourceAssignment_10_1");
			builder.put(grammarAccess.getGroupBiasAccess().getSensitiveVariablesAssignment_14(), "rule__GroupBias__SensitiveVariablesAssignment_14");
			builder.put(grammarAccess.getGroupBiasAccess().getSensitiveVariablesAssignment_15_1(), "rule__GroupBias__SensitiveVariablesAssignment_15_1");
			builder.put(grammarAccess.getGroupBiasAccess().getPositiveOutcomeAssignment_18(), "rule__GroupBias__PositiveOutcomeAssignment_18");
			builder.put(grammarAccess.getGroupBiasAccess().getUnprivilegedGroupAssignment_22(), "rule__GroupBias__UnprivilegedGroupAssignment_22");
			builder.put(grammarAccess.getGroupBiasAccess().getUnprivilegedGroupAssignment_23_1(), "rule__GroupBias__UnprivilegedGroupAssignment_23_1");
			builder.put(grammarAccess.getGroupBiasAccess().getPrivilegedGroupAssignment_27(), "rule__GroupBias__PrivilegedGroupAssignment_27");
			builder.put(grammarAccess.getGroupBiasAccess().getPrivilegedGroupAssignment_28_1(), "rule__GroupBias__PrivilegedGroupAssignment_28_1");
			builder.put(grammarAccess.getGroupBiasAccess().getAnalysisAssignment_33(), "rule__GroupBias__AnalysisAssignment_33");
			builder.put(grammarAccess.getGroupBiasAccess().getAnalysisAssignment_34_1(), "rule__GroupBias__AnalysisAssignment_34_1");
			...
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetAssignment_5(), "rule__GroupAnalysis__DatasetAssignment_5");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetAssignment_6_1(), "rule__GroupAnalysis__DatasetAssignment_6_1");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetUnprivilegedGroupAssignment_9(), "rule__GroupAnalysis__DatasetUnprivilegedGroupAssignment_9");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetUnprivilegedGroupAssignment_10_1(), "rule__GroupAnalysis__DatasetUnprivilegedGroupAssignment_10_1");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetPrivilegedGroupAssignment_12(), "rule__GroupAnalysis__DatasetPrivilegedGroupAssignment_12");
			builder.put(grammarAccess.getGroupAnalysisAccess().getDatasetPrivilegedGroupAssignment_13_1(), "rule__GroupAnalysis__DatasetPrivilegedGroupAssignment_13_1");
			builder.put(grammarAccess.getGroupAnalysisAccess().getMetricAssignment_16(), "rule__GroupAnalysis__MetricAssignment_16");
			builder.put(grammarAccess.getGroupAnalysisAccess().getMetricAssignment_17_1(), "rule__GroupAnalysis__MetricAssignment_17_1");
			...
			builder.put(grammarAccess.getMetricAccess().getFunctionAssignment_9(), "rule__Metric__FunctionAssignment_9");
			builder.put(grammarAccess.getMetricAccess().getOperatorAssignment_11(), "rule__Metric__OperatorAssignment_11");
			...
			builder.put(grammarAccess.getDatasetSensitiveGroupAccess().getNameAssignment_2(), "rule__DatasetSensitiveGroup__NameAssignment_2");
			builder.put(grammarAccess.getDatasetSensitiveGroupAccess().getMappingGroupAssignment_5(), "rule__DatasetSensitiveGroup__MappingGroupAssignment_5");
			builder.put(grammarAccess.getDatasetSensitiveGroupAccess().getSensitiveVariablesAssignment_9(), "rule__DatasetSensitiveGroup__SensitiveVariablesAssignment_9");
			builder.put(grammarAccess.getDatasetSensitiveGroupAccess().getSensitiveVariablesAssignment_10_1(), "rule__DatasetSensitiveGroup__SensitiveVariablesAssignment_10_1");
			...
			builder.put(grammarAccess.getOperationAccess().getEqualityOperatorAssignment_3(), "rule__Operation__EqualityOperatorAssignment_3");
			...
			builder.put(grammarAccess.getGroupSizeAccess().getVariableAssignment_3_1(), "rule__GroupSize__VariableAssignment_3_1");
			builder.put(grammarAccess.getGroupSizeAccess().getGroupConditionAssignment_4_2(), "rule__GroupSize__GroupConditionAssignment_4_2");
			...
			builder.put(grammarAccess.getOperationValueAccess().getValueAssignment_0(), "rule__OperationValue__ValueAssignment_0");
			...
			builder.put(grammarAccess.getSubLogicalConditionAccess().getLogicalOperatorAssignment_0(), "rule__SubLogicalCondition__LogicalOperatorAssignment_0");
			builder.put(grammarAccess.getSubLogicalConditionAccess().getLogicalconditionAssignment_1(), "rule__SubLogicalCondition__LogicalconditionAssignment_1");
			builder.put(grammarAccess.getVariableValue_ImplAccess().getOperatorAssignment_2(), "rule__VariableValue_Impl__OperatorAssignment_2");
			builder.put(grammarAccess.getVariableValue_ImplAccess().getRelativeToDatasetSizeAssignment_3(), "rule__VariableValue_Impl__RelativeToDatasetSizeAssignment_3");
			...
			builder.put(grammarAccess.getDatasetPositiveOutcomeAccess().getOperatorAssignment_8(), "rule__DatasetPositiveOutcome__OperatorAssignment_8");
			builder.put(grammarAccess.getDatasetPositiveOutcomeAccess().getRelativeToDatasetSizeAssignment_9_0(), "rule__DatasetPositiveOutcome__RelativeToDatasetSizeAssignment_9_0");
