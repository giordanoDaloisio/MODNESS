 ...
 * <!-- end-user-doc -->
 * @see fairness.FairnessPackage#getFairnessMetric()
 * @model
 * @generated
 */
public enum FairnessMetric implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final FairnessMetric[] VALUES_ARRAY =
		new FairnessMetric[] {
			STATISTICAL_PARITY,
			DISPARATE_IMPACT,
			EQUALIZED_ODDS,
	 ...
	 * @generated
	 */
	public static final List<FairnessMetric> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static FairnessMetric get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FairnessMetric result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static FairnessMetric getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FairnessMetric result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static FairnessMetric get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FairnessMetric(int value, String name, String literal) {
		this.value = value;
		this.name = name;
